...
extern "C"
{
    ...
    uint32_t sweepcut_without_sorting32_64(uint32_t* ids, uint32_t* results, uint32_t num, 
            uint32_t n, uint64_t* ai, uint32_t* aj, uint32_t offset); 

    uint32_t sweepcut_with_sorting32(double* value, uint32_t* ids, uint32_t* results, 
            uint32_t num, uint32_t n, uint32_t* ai, uint32_t* aj, uint32_t offset); 
    uint64_t sweepcut_with_sorting64(double* value, uint64_t* ids, uint64_t* results, 
            uint64_t num, uint64_t n, uint64_t* ai, uint64_t* aj, uint64_t offset); 
    uint32_t sweepcut_with_sorting32_64(double* value, uint32_t* ids, uint32_t* results, 
            uint32_t num, uint32_t n, uint64_t* ai, uint32_t* aj, uint32_t offset); 
